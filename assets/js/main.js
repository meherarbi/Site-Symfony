		...
		****************************************************/
		tabBundle('#tab');
	  	...
	  	/****************************************************
					Countdown
		****************************************************/
		createCountDown('#event-countdown','2021/02/10');
		createCountDown('#event-countdown-2','2021/02/10');
		createCountDown('#event-countdown-3','2021/02/10');
		createCountDown('#event-countdown-4','2021/02/10');
